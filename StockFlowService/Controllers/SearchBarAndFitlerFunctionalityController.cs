...
namespace StockFlowService.Controllers
{
    ...
    public class SearchBarAndFilterFunctionalityController : Controller
    {
        private readonly ProcedureService _service;

        public SearchBarAndFilterFunctionalityController(ProcedureService service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> GetSearchedList([FromBody] EncryptedRequest request) 
        {
            try
            {
